  ...
  public  class HotelManager
    {
      ...
      public List<CalendarioEntities> calendario(string fecha_desde, string fecha_hasta,int? idNegocio)
      {
          ...
          using (SitcomEntities db = new SitcomEntities())
          {
              ...
              return db.Database.SqlQuery<CalendarioEntities>("ConsultarHabitacionesDisponiblesPorFechaYNegocio_Planning @fecha_desde='"+fecha_desde+"',@fecha_hasta='"+fecha_hasta+"',@idNegocio=" + idNegocio).ToList();
      ...
      public List<HabitacionesDisponiblesEntities> buscarDisponibilidadHabitaciones(string fecha_desde, string fecha_hasta, int idNegocio)
      {

          using (SitcomEntities db = new SitcomEntities())
          {

              return db.Database.SqlQuery<HabitacionesDisponiblesEntities>("ConsultarHabitacionesDisponiblesPorFechaYNegocio @fecha_desde='" + fecha_desde + "',@fecha_hasta= '" + fecha_hasta + "',@idNegocio=" + idNegocio + "").ToList();
